...
$result = mysqli_query($db, "SELECT tickets.id, title, date, custnotes, technotes 
                            FROM `techhelpdb`.`tickets` JOIN `techhelpdb`.`ticket_assignments` on ticket_assignments.ticketid = tickets.id 
